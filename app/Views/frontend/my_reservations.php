                                   ...
                                   <div class="col-lg-12">
                                       <div class="gradient-wrapper item-mb border-none" style="width: fit-content !important;">
                                           <div class="gradient-title">
                                               <div class="row no-gutters">
                                                   <div class="col-4 text-center-mb">
                                                       <h2 class="mb10--mb">My Reservations List</h2>
                                                   </div>
                                           ...
                                           <div id="category-view" class="category-list-layout3 gradient-padding zoom-gallery">
                                               <div class="row">
                                                    <div class="col-lg-12">
                                                        <?php echo $ad_reservations_grid_out; ?>
                                                    </div>
                                               </div>
                                           </div>
                                       </div>
   ...
   <input type="hidden" class="csrfname_field" name="<?php echo csrf_token() ?>" value="<?php echo csrf_hash() ?>" />
        ...
        <script type="text/javascript">
            function grid_onload(ids) {
                $('.cancelReservationBtn').each(function(){
            ...
            jQuery('#gridlist').jqGrid('navButtonAdd', '#gridlist_pager',
        {
            ...
            function cancelReservation(e){
                ...
                if(record_id == "") return false;
                 ...
                 swalWithBootstrapButtons.fire({
                   ...
                   confirmButtonText: 'Yes, cancel the reservation!',
                   ...
                   if (result.isConfirmed) {
                     ...
                     var dataJson = { [csrfName]: csrfHash, record_id: record_id,form_name: 'cancelReservation'};
                     $.ajax({
                         type: "POST",  
