    ...
    <div class="container">
        <div class="row">
                ...
                <div class="gradient-wrapper mb--sm">
                    ...
                    <div class="contact-layout1 gradient-padding">
                        <div class="sidebar-item-box">
                            <img src="<?php echo base_url() ?>public/img/banner/contact2.jpg" alt="banner" class="img-fluid m-auto">
                        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12">
                <div class="sidebar-item-box">
                    <img src="<?php echo base_url() ?>public/img/banner/contact3.png" alt="banner" class="img-fluid m-auto">
                </div>
            </div>
        </div>
    </div>
